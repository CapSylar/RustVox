...
{
    use engine::generational_vec::{GenerationalVec, GenerationErr};

    #[test]
    fn capacity_test()
    {
        let mut arena: GenerationalVec<u32> = GenerationalVec::new(100);
    ...
    fn double_remove()
    {
        let mut arena:GenerationalVec<u32> = GenerationalVec::new(3);
    ...
    fn rug_pull()
    {
        let mut arena:GenerationalVec<u32> = GenerationalVec::new(1);
