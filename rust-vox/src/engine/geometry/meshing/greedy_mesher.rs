...
// use glam::{Vec2, Vec3};
// use crate::engine::{chunk::{Chunk, CHUNK_SIZE}, geometry::{voxel_vertex::VoxelVertex, mesh::Mesh, opengl_vertex::OpenglVertex, voxel::VoxelType}};
...
// {
//     //TODO: this is a mess
//     fn add_quad(mesh: &mut Mesh<VoxelVertex>, voxel_type:VoxelType, lower_left:(i32,i32,i32), upper_left: (i32,i32,i32), upper_right:(i32,i32,i32), lower_right:(i32,i32,i32))
//     {
//         // append the quad
//         mesh.add_quad(
//             VoxelVertex::new(Vec3::new(lower_left.0 as f32 * VOXEL_SIZE,lower_left.1 as f32 * VOXEL_SIZE,lower_left.2 as f32 * VOXEL_SIZE),0,UVs::LowerLeft as u8, voxel_type as u8),
//             VoxelVertex::new(Vec3::new(upper_left.0 as f32 * VOXEL_SIZE, upper_left.1 as f32 * VOXEL_SIZE, upper_left.2 as f32 * VOXEL_SIZE),0,UVs::UpperLeft as u8, voxel_type as u8),
//             VoxelVertex::new(Vec3::new(upper_right.0 as f32 * VOXEL_SIZE,upper_right.1 as f32 * VOXEL_SIZE,upper_right.2 as f32 * VOXEL_SIZE),0,UVs::UpperRight as u8, voxel_type as u8),
//             VoxelVertex::new(Vec3::new(lower_right.0 as f32 * VOXEL_SIZE, lower_right.1 as f32 * VOXEL_SIZE, lower_right.2 as f32 * VOXEL_SIZE),0,UVs::LowerRight as u8, voxel_type as u8)
//         );
//     }
// }
